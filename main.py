...
if simulation_type == "직선 전류":
    ...
    st.markdown("<span style='font-size: 70%;'>($B=k(I/r)$)</span>", unsafe_allow_html=True)
...
# 2. 원형 전류에 의한 자기장 (3D)
    ...
    st.markdown("<span style='font-size: 70%;'>($B=k'(I/r)$, $k'=\pi k$)</span>", unsafe_allow_html=True)
...
# 3. 솔레노이드에 의한 자기장 (3D)
    ...
    st.markdown("<span style='font-size: 70%;'>($B=k''(I/r)$, $k''=2k'=2\pi k$)</span>", unsafe_allow_html=True)
