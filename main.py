...
if simulation_type == "직선 전류":
    ...
    st.markdown("<span style='font-size: 150%;' $$<span style='color:red'>B</span>=<span style='color:green'>k</span>\\frac{><span style='color:blue'>I</span>}{r}$$", unsafe_allow_html=True)
