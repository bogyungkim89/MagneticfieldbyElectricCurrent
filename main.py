...
if simulation_type == "직선 전류":
    ...
    st.markdown("<span style='font-size: 150%;'><span style='color:red'>B</span><span style='color:blue'>I</span><span style='color:green'>k</span> $$B=k\\frac{I}{r}$$", unsafe_allow_html=True)
...
# 2. 원형 전류에 의한 자기장 (3D)
    ...
    st.markdown("<span style='font-size: 150%;'><span style='color:red;'>$$B$$</span>=<span style='color:green;'>$$k'$$</span>\\frac{<span style='color:blue;'>$$I$$</span>}{<span style='color:green;'>$$r$$</span>}, <span style='color:green;'>$$k'$$</span>=\\pi <span style='color:green;'>$$k$$</span>$$</span>", unsafe_allow_html=True)
...
# 3. 솔레노이드에 의한 자기장 (3D)
    ...
    st.markdown("<span style='font-size: 150%;'>$$B=k''nI, k''=2k'=2\pi k$$</span>", unsafe_allow_html=True)
